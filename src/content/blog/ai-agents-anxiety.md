...
It has access to my system. It installs packages I didn't ask for. It occasionally just does dumb stuff with full confidence. And every time it runs a command I didn't expect, my heart rate goes up a little.
